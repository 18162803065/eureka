 ...
 * uncompressed).
 *
 * 这个测试里面会将eureka注册中心启动起来，然后模拟eureka客户端（服务）去发送各种请求到eureka注册中心，去测试个各种功能
 *
 * @author Tomasz Bak
 */
public class EurekaClientServerRestIntegrationTest {
    ...
    private static void startServer() throws Exception {
        // 先找到eureka得war包  基于war包将jetty启动起来了 ，jetty启动起来之后  euerkaserver也启动起来了
...
//        eurekaServiceUrl = "http://localhost:8080/v2";
        ...
        // 代码层面先把jety启动起来 jetty启动起来之后 顺带把eureka本身这个web应用 也启动起来了
